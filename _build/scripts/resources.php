...
[
	{
		...
		"prompt" : "Vas a actuar como un experto en desarrollo de negocios, me ayudarás a [[+curr_content]], para tu analisis usaras el modelo LEAN/Agile, y te enfocaras en proveer información clara, con objetivos que cumplan con el modelo SMART, tu objetivo final es generar concretas sobre las cuales pueda tomar accion, como planes de contenido, estrategias de mercadeo, o planes de produccion, toma esto como ideas, pero no te limites en las opciones y planes que sugieras",
		"options" : "{ \"elements\" : [\"crear un nuevo producto/servicio\", \"Mejorar un negocio que ya esta funcionando\"]}",
		"ai_generated" : 1,
		"api_call" : 0,
		"question_type" : 2,
		"gpt_function" : ""
	},
	{
		...
		"prompt" : "Mi negocio es: [[+curr_content]]. Analiza la descripción que te di de mi negocio, y hazme 3 preguntas que me ayuden a mejorar esta definicion, considera elementos como el publico objetivo o la oferta de valor sean claras entre otras opciones, pero no te limites solo a estos 3 elementos y ayudame a indagar elementos claves dentro de mi negocio, cada pregunta no puede exceder los 200 caracteres, generalas en formato json, usa la funcion elements",
		"options" : "",
		"ai_generated" : 0,
		"api_call" : 1,
		"question_type" : 1,
	...
	},
	{
		...
		"prompt" : "De las estrategias que me sugeriste vamos a implementar [[+curr_content]]. Ahora necesito que crees un plan semanal para 3 semanas de trabajo, cada plan semanal debe tener un titulo y un párrafo corto donde se describa un OKR para la semana, los planes pueden ser campañas de redes sociales, cambio de imagen, marketing de redes sociales, diseño de producto entre otros. Dentro de cada plan, debes generar un arreglo con cinco actividades a realizar durante cada una de las semanas, debes asegurarte que las actividades no sean repetitivas, y generen valor ofreciendo acciones concretas que ayuden a cumplir las metas. Para generar tu respuesta, ten en cuenta todos los elementos de esta conversacion, y busca que tu plan este enfocado en tomar accion, y medir resultados, por ejemplo si se esta diseñando un producto, se debe enfocar la respuesta en llegar a hacer pruebas con el usuario, o si se esta en un plan de marketing, se deben dar pasos concretos en aras de generar ventas, el modelo general del plan puede ser similar al de un proyecto, donde una semana planeas, y las otras dos ejecutas, cierras y mides. por favor usar la funcion finalPlan para generar el json de respuesta con 3 planes",
		"options" : "",
		"ai_generated" : 1,
		"api_call" : 1,
		"question_type" : 2,
